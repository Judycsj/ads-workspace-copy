<!-- ads-workspace-gdoc-sync: gdoc_id=1va9M1bCJQxiyzuv7P2eVb8rsrQeHiBWuVzFocjYdZuw gdoc_url=https://docs.google.com/document/d/1va9M1bCJQxiyzuv7P2eVb8rsrQeHiBWuVzFocjYdZuw/edit -->

# traffic_omni_oa.dwd_order_item_atc_journey_di

## 外部表状态

- status: `resolved_search`
- requested_table: `traffic_omni_oa.dwd_order_item_atc_journey_di`
- canonical_table: `traffic_omni_oa.dwd_order_item_atc_journey_di__ar_sensitive_live`
- resolution: `datamap_search:exact`
- source: `https://sradata.shopee.io/admin/api/datamap/table/info`
- business_docs: `ads_metric_ads_item_gmv_pct`, `ads_metric_ads_seller_gmv_pct`, `ads_metric_seller_adoption`
...
- inferred_partition_keys: `grass_date`
- required_filters: `grass_date`
...
- `traffic_omni_oa.dwd_order_item_atc_journey_di` via `https://sradata.shopee.io/admin/api/datamap/table/info`: 表不存在
- `traffic_omni_oa.dwd_order_item_atc_journey_di` via `https://sradata.test.shopee.io/admin/api/datamap/table/info`: 表不存在
- `traffic_omni_oa.dwd_order_item_atc_journey_di` via `datasuite_describe`: 653
--------------------------------------------------------------------
Task Execution Fail
--------------------------------------------------------------------
2026-05-19 16:14:42 (UTC+8) INFO - Whole task execution ended
2026-05-19 16:14:42 (UTC+8) INFO - Total Elapse time: [5969]ms
2026-05-19 16:14:42 (UTC+8) INFO - Share this execution log for troubleshooting:
 https://datasuite.shopee.io/scheduler/dev/adhoc/adhoc_fqVSaaje_20260519161434/log
2026-05-19 16:14:42 (UTC+8) INFO - <exec-log-eof>
