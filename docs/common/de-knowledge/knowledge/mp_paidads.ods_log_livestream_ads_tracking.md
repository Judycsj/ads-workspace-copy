<!-- ads-workspace-gdoc-sync: gdoc_id=13iFlKP-fm5Y55KA0q4NH2_j-D-aKpAuL4n2r_gR8p0s gdoc_url=https://docs.google.com/document/d/13iFlKP-fm5Y55KA0q4NH2_j-D-aKpAuL4n2r_gR8p0s/edit -->

# mp_paidads.ods_log_livestream_ads_tracking
...
| 属性 | 值 |
|---|---|
| Topic | `shopee_ads_livestream_ads_id_live,shopee_ads_livestream_ads_vn_live,shopee_ads_livestream_ads_{region}_live` |
| Consumer Group | `paidads-livestreaming-hdfs-sink-63be55` |
| Brokers | `kafka.ks_adsTracking_live.ap-sg-1-general-b.live.mq.shopee.io:9092` |
...
| 35 | `videos` | TrackingVideo | struct<...> |
...
| 25 | `internal` | Internal | struct<deduction_info:struct<quality:double,bidprice:bigint,next_score:double,next_adsid:bigint,next_ads_keyword:string,algo_name:string,boost_status:string,deduction_price:bigint,ads_id:bigint,placement:int>> |
| 26 | `request_id` | string | string |
| 27 | `video_id` | string | string |
| 28 | `click_area` | int32 | int |
| 29 | `item_video` | ItemVideo | struct<display_video_id:bigint,is_affiliated:boolean,video_creator_id:bigint,seller_id:bigint |
| 32 | `display_ad_tag` | int32 | int |
| 33 | `item_rcmd_props` | TrackingItemRcmdProps | TrackingItemRcmdProps |
| 34 | `target_type` | string | string |
| 35 | `traffic_source` | int32 | int |
| 36 | `item_voucher` | ItemVoucher | ItemVoucher |
| 37 | `vmodelid` | int64 | bigint |
| 38 | `vitemid` | int64 | bigint |
| 39 | `ctx_item_type` | int32 | int |
| 40 | `rsku_list_infos` | RskuListinfo | RskuListinfo |
...
| 8 | `internal` | Internal | struct<deduction_info:struct<quality:double,bidprice:bigint,next_score:double,next_adsid:bigint,next_ads_keyword:string,algo_name:string,boost_status:string,deduction_price:bigint,ads_id:bigint,placement:int>> |
...
| 17 | `shop_banners` | TrackingShopBanner | TrackingShopBanner |
...
| 11 | `banner_internal` | BannerInternal | BannerInternal |
...
| 10 | `items` | TrackingLiveItem | array<struct<item_id:bigint,shop_id:bigint,target_type:string>> |
| 11 | `internal` | LivestreamInternal | struct<cpm_deduction_info:struct<cpm:bigint,ads_id:bigint,placement:int>,frauds:array<struct<fraud_type:string>>,event_id:string,request_id:string,ads_request_id:string,algo_json_data:string> |
...
### TrackingVideo（`videos` 的嵌套消息，ODS 类型: struct）
...
| 15 | `items` | TrackingVideoItem | TrackingVideoItem |
| 16 | `internal` | VideoInternal | VideoInternal |
