<!-- ads-workspace-gdoc-sync: gdoc_id=1cml7xMIjCQ4sx7a3jXa4T-rmRk0LAXmB8KiDri__yIM gdoc_url=https://docs.google.com/document/d/1cml7xMIjCQ4sx7a3jXa4T-rmRk0LAXmB8KiDri__yIM/edit -->

# mp_paidads.ods_log_ads_tracking_hi
...
| 属性 | 值 |
|---|---|
| Topic | `shopee_ads_{region}_live` |
| Consumer Group | `paidads-datax` |
...
| 25 | `livestreams` | TrackingLivestream | struct<...> |
...
| 25 | `internal` | Internal | struct<frauds:array<struct<fraud_type:string>>,deduction_info:struct<quality:double,bidprice:bigint,next_score:double,next_adsid:bigint,next_ads_keyword:string,algo_name:string,boost_status:string,deduction_price:bigint,ads_id:bigint,placement:int,bid_deduction_price:bigint,is_ocpm:boolean>,event_id:string,cpm_deduction_info:struct<cpm:bigint,ads_id:bigint,placement:int>,duplicate_label:int,algo_json_data:string> |
...
| 8 | `internal` | Internal | struct<frauds:array<struct<fraud_type:string>>,deduction_info:struct<quality:double,bidprice:bigint,next_score:double,next_adsid:bigint,next_ads_keyword:string,algo_name:string,boost_status:string,deduction_price:bigint,ads_id:bigint,placement:int,bid_deduction_price:bigint,is_ocpm:boolean>,event_id:string,cpm_deduction_info:struct<cpm:bigint,ads_id:bigint,placement:int>,duplicate_label:int> |
...
| 11 | `banner_internal` | BannerInternal | struct<cpm:bigint,request_id:string,ads_request_id:string,event_id:string> |
...
### TrackingLivestream（`livestreams` 的嵌套消息，ODS 类型: struct）
...
| 10 | `items` | TrackingLiveItem | TrackingLiveItem |
| 11 | `internal` | LivestreamInternal | LivestreamInternal |
